 ...
 */
static touch_ret_t touch_sensors_config(uint8_t sensitivity);
...
/* Node configurations */
qtm_acq_t161x_node_config_t ptc_seq_node_cfg1[DEF_NUM_CHANNELS] = {NODE_0_PARAMS, NODE_1_PARAMS};
...
Notes  :
============================================================================*/
void touch_init(uint8_t sensitivity)
{
	...
	touch_sensors_config(sensitivity);
}
