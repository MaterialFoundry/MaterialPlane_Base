...
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(9), Y(8), 0, NODE_RSEL_PRSC(RSEL_VAL_50, PRSC_DIV_SEL_4), NODE_GAIN(GAIN_4, GAIN_1), FILTER_LEVEL_8          \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(7), Y(6), 0, NODE_RSEL_PRSC(RSEL_VAL_50, PRSC_DIV_SEL_4), NODE_GAIN(GAIN_4, GAIN_1), FILTER_LEVEL_8          \
	}
...
#define DEF_MEDIAN_FILTER_FREQUENCIES FREQ_SEL_0, FREQ_SEL_8, FREQ_SEL_14
